...
if(branchname===branchdata.activebranch){
    return res.status(400).json({
        message:`can not delete active branch ${branchname} `,
      });
    
}

delete branchdata.branches[branchname];
console.log('after branch delete',branchdata.branches);
